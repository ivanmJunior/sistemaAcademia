  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active"><a href="#"><i class="fa fa-users"></i> <span>Agendar Avaliação</span></a></li>
        <li class="active"><a href="<%=request.getContextPath()%>/ControllerListarTreinos"><i class="fa fa-users"></i> <span>Marcar Treino</span></a></li>
        <li class="active"><a href="#"><i class="fa fa-users"></i> <span>Resultados</span></a></li>
        <li class="active"><a href="#"><i class="fa fa-users"></i> <span>Ficha de Avaliação</span></a></li>
        
      </ul>
      <ul class="sidebar-menu" data-widget="tree">
        <li class="header">Financeiro</li>
        <!-- Optionally, you can add icons to the links -->
        <li class="active"><a href="#"><i class="fa fa-users"></i> <span>2º via Boleto</span></a></li>
        <li class="active"><a href="#"><i class="fa fa-users"></i> <span>Extrato de Pagamentos</span></a></li>
      </ul>
      <!-- /.sidebar-menu -->
    </section>
    <!-- /.sidebar -->
    ...
    <section class="content container-fluid">
      ...
      <div class="row">
        ...
        <div class="col-md-8">
          ...
          <div class="box" id="divAreaTabelaTreino">
            ...
            <div class="box-body no-padding">
              <table class="table table-striped" id="tabelaTreinos">
                <thead>
                  <tr>
                    <th>Intrutor</th>
        ...
        <div class="col-md-4">
          ...
          <div class="box box-success">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" id="form-user-create" action="<%=request.getContextPath()%>/ControllerInserirTreino" method="post">
              <div class="box-body">
                <div class="form-group">
                  <label for="exampleInputName">Instrutor</label>
                  <input type="text" class="form-control" id="exampleInputName" placeholder="Digite o nome do usuário" name="txtNomeAreaCli" required="true">
                </div>
