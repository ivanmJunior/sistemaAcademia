  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active"><a href="#1"><i class="fa fa-users"></i> <span>Agendar Avaliação</span></a></li>
        <li class="active"><a href="#6"><i class="fa fa-users"></i> <span>Marcar Treino</span></a></li>
        <li class="active"><a href="#2"><i class="fa fa-users"></i> <span>Resultados</span></a></li>
        <li class="active"><a href="#3"><i class="fa fa-users"></i> <span>Ficha de Avaliação</span></a></li>
        
      </ul>
      <ul class="sidebar-menu" data-widget="tree">
        <li class="header">Financeiro</li>
        <!-- Optionally, you can add icons to the links -->
        <li class="active"><a href="#4"><i class="fa fa-users"></i> <span>2º via Boleto</span></a></li>
        <li class="active"><a href="#5"><i class="fa fa-users"></i> <span>Extrato de Pagamentos</span></a></li>
      </ul>
      <!-- /.sidebar-menu -->
    </section>
    <!-- /.sidebar -->
            ...
            <form role="form" id="form-user-create" action="<%=request.getContextPath()%>/adicionaTreino" method="post">
              <div class="box-body">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="exampleInputName" placeholder="Digite o nome do usuário" name="instrutor.nome" required="true" minlength="5">
                </div>
