...
<body>
	...
	<div class="container">
		...
		<form class="needs-validation" novalidate
			action="<%=request.getContextPath()%>/${objetoFuncao.metodo}"
			method="post">
			<div class="p-4 bg-light rounded">
				<div class="form-row">
					<div class="col-md-4 mb-3">
						<label for="validationNome">Nome</label> <input type="text"
							min="10" name="nome" class="form-control" id="validationNome"
					...
					<div class="col-md-2 mb-3">
						<label for="validationCPF">CPF</label> <input type="text" min="11"
							max="11" name="cpf" class="form-control" id="validationCPF"
							placeholder="99999999999" required>
						<div class="invalid-feedback">Informe CPF.</div>
					</div>
				</div>
				<div class="form-row">
					<div class="col-md-4 mb-3">
			...
			<div class="p-4 bg-light rounded">
				<div class="form-row">
					...
					<div class="col-md-4 mb-3">
						...
						<label class="form-control" > ${objetoFuncao.funcao} </label>
							<input type="hidden" name="funcao" value="${objetoFuncao.funcao}" class="form-control"
							id="exampleInputCountryFuncao">
					</div>
					<div class="col-md-4 mb-3">
					...
					<div class="col-md-6 mb-3">
						<label for="cbBoxModalidades">Modalidades</label> <select
							class="form-control" id="cbBoxModalidades" name="modalidades"
							>
							<option value="" selected="selected">Modalidades</option>
							<c:forEach items="${objetoFuncao.listaModalidades}"
								var="modalidade">
								<option value="${modalidade.descricao}">${modalidade.descricao}</option>
							</c:forEach>
						</select>
						
						<button type="button" class="btn btn-outline-success my-2 my-sm-3" onclick="adicionarEspecialidade();">Adicionar ></button>
						<button type="button" class="btn btn-outline-danger my-2 my-sm-3" onclick="removerEspecialidade();">Remover <</button>
						<button type="button" class="btn btn-outline-success my-2 my-sm-3" onclick="adicionarEspecialidade();">Adicionar >></button>
						<button type="button" class="btn btn-outline-danger my-2 my-sm-3" onclick="adicionarEspecialidade();">Remover <<</button>
					</div>
					<div class="col-md-6 mb-3">
						<div class="form-group">
							<label  for="listaEspecialidades">Especialidades </label>
							<select multiple class="form-control" id="listaEspecialidades" name="especialidades">
	...
	<script src="<%=request.getContextPath()%>/resources/js/adicionarRemoverItemLista.js"></script>
